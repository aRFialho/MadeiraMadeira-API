...
(() => {
  ...
  async function loadWhoAmI() {
    try {
      // /api/account/whoami não existe neste projeto; usar o endpoint oficial do app
      const data = await getJSON("/api/account/current");
      const label = data?.label || data?.accountKey || "Conta selecionada";
